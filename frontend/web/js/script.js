...
/* 	setInterval(function(){
        ...
        changeStatus('.trNew', urlSite+'/frontend/web/zakaz/adopted?id=');
        changeStatus('.trNewUpdate', urlSite+'/frontend/web/zakaz/adopupdate?id=');
        changeStatus('.trNewMaster', urlSite+'/frontend/web/zakaz/adopmaster?id=');
        changeStatus('.trNewDesign', urlSite+'/frontend/web/zakaz/adopdesign?id=');
=======
$(document).ready(function(){
 /*	setInterval(function(){
